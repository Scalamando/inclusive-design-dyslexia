<template>
  <section id="guidelines-section" class="mb-4 w-[90ch] max-w-[calc(100vw-1.75rem)] sm:max-w-[calc(100vw-3rem)] lg:max-w-[calc(100vw-var(--nav-width))]">
          ...
          Guidelines: [
            {
              ...
              dontStyle: "border-accent-red  doDont",
            },
            {
              title: "Schriftart",
